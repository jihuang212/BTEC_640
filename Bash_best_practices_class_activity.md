...
>
>#Output: 
>Applications	Downloads	Music		R5.R
...
>
>#Output
>drwxr-xr-x@ 6 janehuang  staff  192 Sep  9 20:56 btec_640
>drwxr-xr-x@ 3 janehuang  staff   96 Sep  9 17:36 GitHub
>-rw-r--r--  1 janehuang  staff    0 Sep 10 18:19 mkdir
>drwxr-xr-x@ 8 janehuang  staff  256 Apr 15  2025 Zoom
>
>```
>
...
> <br>
>**Type your answer here:** class_exercises, genomics_project, transcriptomics_project
><br>
><br>
><br>
><br>
...
>Without -p, it'll only create one folder each time you do it. 
><br>
><br>
><br>
...
> ```
>mkdir -p btec_640/genomics_project/input_data
>mkdir -p btec_640/genomics_project/final_output
>mkdir -p btec_640/genomics_project/analysis
>mkdir -p btec_640/genomics_project/src
>mkdir -p btec_640/transcriptomics_project/input_data
>mkdir -p btec_640/transcriptomics_project/final_output
>mkdir -p btec_640/transcriptomics_project/analysis
>mkdir -p btec_640/transcriptomics_project/src
>```
